...
2. **Option: Ihr nutzt bereits einen MQTT-Broker in Home Assistant**
   ...
   5. **Manuelle Einfügung**
      ...
      + Nun solltet ihr unter den o. a. Namen die entsprechenden Sensoren findet. Die wenigsten werden von vorne herein bereits einen Wert haben, da wie anfänglich erwähnt der Zendure-Broker nur Werteänderungen ausspielt, wenn sich der jeweilige Wert im Vergleich zu seinem vorherigen Status geändert hat.
